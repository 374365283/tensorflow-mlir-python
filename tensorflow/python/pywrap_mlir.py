...
def experimental_run_pdl_pass_pipeline(mlir_txt,
                          mlir_pdl_txt,
                          show_debug_info):
    return ExperimentalRunPDLPassPipeline(str(mlir_txt).encode('utf-8'), 
           str(mlir_pdl_txt).encode('utf-8'), show_debug_info)
